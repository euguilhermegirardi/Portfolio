         ...
         <div className="resume__timeline">
            <article className="resume__article">
               ...
               <div className="resume__article-company">
                  <small className="resume__article-small">Home Office</small>
               </div>
               <div className="resume__article-date">
                  <span className="resume__article-span">2018 - Present</span>
               </div>
               ...
               <div className="resume__description">
                  <p className="paragraph resume__p">
                     ...
                     React Native and Node.js. Identifying problems and bugs in
                     the code and quickly resolving the problems.
                  </p>
               </div>
            </article>
            ...
            <article className="resume__article">
               ...
               <div className="resume__description">
                  <p className="paragraph resume__p">
                     ...
                     appropriate execution projects, monitoring of the physical
                     and supply schedules, the budget of the services to be
                     executed and of the materials, purchase of materials,
                     preparation of weekly reports, supervision of the work
                     safety of all employees, and review of projects.
                  </p>
               </div>
            </article>
